...
> 7그룹 17과업. 그룹으로 진행률을 보고, 과업으로 오너십을 준다.
> 마지막 업데이트: 2026-04-08
...
#### 2. UT-prototyping `Tier 1`
**한줄 정의**: UT 시나리오 + 태스크 플로우 자동 생성
**문제 심각도**: ★★★☆☆ (3/5)
- UT 준비에 1~2일. 시나리오 셋업이 수작업
- 선: UT 프로토타이핑을 핵심 과업으로 집중

**솔루션 설계**
- v1: Skill로 "디자인 컨텍스트 → UT 시나리오 + 태스크 스크립트" 자동 생성. 프로토타입 연결은 수동
- v2: Figma 프로토타입 모드 API 연동 (장기)

**만드는 방법**
1. UT 시나리오 템플릿 MD 작성 (태스크, 성공 기준, 관찰 포인트)
2. Skill 프롬프트: "화면 설명 + 검증 목표 → UT 시나리오 문서"
3. 3건 실제 UT에 적용
4. 피드백 수집 → 템플릿 개선

**해외 사례**: 직접 대응 없음. Babylon Health의 "AI가 테스트 스크립트 생성"과 유사

**성공 지표**: UT 준비 시간 50% 단축, UT 실행 빈도 증가
**선행 조건**: UT 시나리오 템플릿
...
#### 3. Design-knowledge-playbook `Tier 1`
...
#### 12. Data-insight `Tier 2` `Quick Win`
...
#### 16. UX-writing
Design-draft의 부가 기능. 카피 생성을 Design-draft 프롬프트에 포함하여 별도 도구 불필요.

#### 17. Responsive-support
Design-draft의 부가 기능. HTML 생성 시 CSS 미디어쿼리 포함하여 반응형 자동 해결.
...
| 6 | Spec-policy-handoff | Complete-handoff | 2~3주 | 할당 대기 |
| 7 | State-verifier | Complete-handoff | 1~2주 | 할당 대기 |
| 8 | Design-handoff-doc | Complete-handoff | 1~2주 | 할당 대기 |
| 9 | Edge-case-simulator | Quality & Verification | 2~3주 | 할당 대기 |
| 10 | Design-QA | Quality & Verification | 3~4주 | 할당 대기 |

### Tier 2 — Quick Win (3개)
| # | 과업 | 그룹 | 소요 | 오너 |
|---|---|---|---|---|
| 11 | Data-insight | Platform | 1~2주 | 할당 대기 |
| 12 | Design-critique | Review | 1~2주 | 할당 대기 |
| 13 | Team-toolkit | Platform | 2~3주 | 할당 대기 |

### Tier 3 — 중기 (2개 + 부가)
| # | 과업 | 그룹 | 소요 | 오너 |
|---|---|---|---|---|
| 14 | Insight-archive | Platform | 3~4주 | 할당 대기 |
| 15 | Reference-analyzer | Platform | 2~3주 | 할당 대기 |
| - | UX-writing | 부가 | Design-draft에 포함 | - |
| - | Responsive-support | 부가 | Design-draft에 포함 | - |
